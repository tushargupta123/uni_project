...
function Api() {
  ...
  <div className="container">
    <section className="row pt-5">
        <div className="col-sm-12 col-md-6 col-lg-5 d-flex flex-column justify-content-center">
          ...
          <div className="pt-3">
          Aladdin Studio APIs enable you to build your own solutions with access to the breadth and depth of Aladdin data and capabilities. Retrieve, write, and modify data from across the Aladdin ecosystem to power proprietary applications and create custom tools that meet your needs.
          </div>
          <div className="pt-3">
      ...
      <section className="my_50 col-sm-12 col-md-6 col-lg-5 d-flex flex-column justify-content-center">
        <p className="h2">What are APIs? How can I use them in Aladdin Studio?</p>
        <p className="py-3">
      ...
      <section className="my_50">
        <div className="row">
          <div className="col col-sm-12 col-md-4">
            <img src="https://www.blackrock.com/blk-inst-assets/cache-1635533361000/images/aladdin/icons/ald-icn-flexibility-yel-rgb.webp" alt="" className="my_icon"/>
            <h4><b>Easy integration</b></h4>
            <p>Seamless connection between Aladdin and your ecosystem.</p>
          </div>
          <div className="col col-sm-12 col-md-4">
            <img src="https://www.blackrock.com/blk-inst-assets/cache-1635533361000/images/aladdin/icons/ald-icn-scale-blu-rgb.webp" alt="" className="my_icon"/>
            <h4><b>Enhanced processes</b></h4>
            <p>Scalable ways to automate workflows and analysis.</p>
          </div>
          <div className="col col-sm-12 col-md-4">
            <img src="https://www.blackrock.com/blk-inst-assets/cache-1635533361000/images/aladdin/icons/ald-icn-integrated-yel-rgb.webp" alt="" className="my_icon"/>
            <h4><b>Dynamic customization</b></h4>
  ...
  <div class="accordion-item">
    ...
    <div id="flush-collapseOne" class="accordion-collapse collapse" aria-labelledby="flush-headingOne" data-bs-parent="#accordionFlushExample">
      <div class="accordion-body">Aladdin Studio already has a large universe of available APIs, and we are always expanding our offerings in response to the bespoke needs of our developer community.</div>
    </div>
  </div>
  <div class="accordion-item">
    ...
    <div id="flush-collapseTwo" class="accordion-collapse collapse" aria-labelledby="flush-headingTwo" data-bs-parent="#accordionFlushExample">
      <div class="accordion-body">Aladdin Studio documentation teaches you how Aladdin API requests are built, authorized, and processed in our system.</div>
    </div>
  </div>
  <div class="accordion-item">
  ...
  <div class="accordion-item">
    ...
    <div id="flush-collapseFour" class="accordion-collapse collapse" aria-labelledby="flush-headingFour" data-bs-parent="#accordionFlushExample">
      <div class="accordion-body">Our Data Dictionary allows you to explore Aladdin data and search for the field definitions you need.</div>
    </div>
  </div>
</div>
      </section>
      ...
      <section className="mid-color row my_50">
        <p><b>ADDITIONAL ALADDIN STUDIO RESOURCES</b></p><br/>
        <div className="row">
      ...
      <section>
        ...
        <form action="#">
          ...
          <div className="row">
            <div className="col">
            <input type="checkbox" name="check" id="" /> Please click here to opt-in to receiving future marketing communications from BlackRock
            </div>
          </div>
          <div className="row">
            <div className="col col-11"></div>
            <div className="col col-1">
              <div className="btn btn-secondary mb-3" >Submit</div>
            </div>
          </div>
        </form>
      </section>
